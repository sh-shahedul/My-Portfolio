        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="hidden md:block absolute left-1/2 -translate-x-1/2 w-1 bg-gradient-to-b 
                         from-cyan-500/70 via-blue-500/50 to-purple-500/70 rounded-full shadow-lg shadow-cyan-400/50 will-change-transform"
            >
              {/* Animated Dots on Timeline */}
              {timeline.map((_, index) => (
                <motion.div
              ...
              {timeline.map((item, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`relative flex flex-col md:flex-row items-start md:items-center gap-6 education-card
                      ${reverse ? "md:flex-row-reverse" : ""}`}
                  >
                    ...
                    <div className={`flex flex-col md:w-1/2 ${reverse ? "md:items-end" : "md:items-start"}`}>
                      ...
                      >
                        {/* Icon with Gradient */}
                        <motion.div
                          className={`relative p-5 rounded-2xl bg-gradient-to-br ${item.color} shadow-2xl will-change-transform`}
                          whileHover={{ 
                            scale: 1.08,
                            rotate: [0, -5, 5, -5, 0],
                    ...
                    >
                      <motion.div
                        ...
                        className="relative bg-white/5 backdrop-blur-md border border-cyan-400/20 hover:border-cyan-400/50 
                                 rounded-2xl p-8 shadow-lg transition-all duration-200 overflow-hidden will-change-transform"
                      >
                        {/* Hover Glow Effect */}
                        <motion.div
