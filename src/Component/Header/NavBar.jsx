...
const NavBar = () => {
  return (
    <div className="w-full bg-[#05080E] font-inter">
        ...
        <div className="navbar flex items-center justify-between py-4">
          ...
          <div className="navbar-center hidden lg:flex">
            <ul className="menu menu-horizontal px-1 space-x-4">
              <li><a href="#about" className="text-slate-300 hover:text-primary">About</a></li>
              <li><a href="#service" className="text-slate-300 hover:text-primary">Service</a></li>
              <li><a href="#skills" className="text-slate-300 hover:text-primary">Skills</a></li>
              <li><a href="#education" className="text-slate-300 hover:text-primary">Education</a></li>
              <li><a href="#contact" className="text-slate-300 hover:text-primary">Contact me</a></li>
            </ul>
          </div>
