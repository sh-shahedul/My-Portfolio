      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            {services.map((service, index) => (
              ...
              >
                ...
                {/* Card Container */}
                <motion.div 
                  className="relative p-8 rounded-2xl bg-white/5 backdrop-blur-md border border-cyan-400/20 hover:border-cyan-400/50 shadow-lg transition-all duration-300 h-full flex flex-col will-change-transform"
                  whileHover={{ 
                    y: -10,
                    boxShadow: "0 20px 40px rgba(6, 182, 212, 0.3)",
                ...
                >
                  {/* Icon Container */}
                  <motion.div
                    className={`relative w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br ${service.color} ${service.shadowColor} shadow-2xl flex items-center justify-center will-change-transform`}
                    whileHover={{ 
                      rotate: [0, -10, 10, -10, 0],
                      scale: 1.1,
          ...
          >
            <motion.button
              onClick={handleEmailClick}
              className="group relative inline-flex items-center gap-2 px-10 py-5 rounded-full overflow-hidden font-bold text-lg cursor-pointer will-change-transform"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              {/* Animated Background */}
