...
//     <section
//       id="about"
//       className="py-20 bg-white dark:bg-[#050b18]"
//     >
...
//             {/* Border */}
//             <div className="absolute -bottom-4 -right-4 w-full h-full border-4 border-cyan-400 rounded-xl"></div>
...
//             Hello, I’m <span className="font-semibold text-gray-900 dark:text-white">Ashadul Islam</span>.
