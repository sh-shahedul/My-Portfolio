...
/* ================= Floating Particles ================= */
const FloatingParticles = () => {
  // Mobile-এ কম particles দেখাবে performance এর জন্য
...
const AboutMe = () => {
  // Smart Email Handler (PC এবং Mobile উভয়ের জন্য)
  const handleEmailClick = () => {
    const email = "shahedulhoque2003@gmail.com";
    const isMobile = /Mobi|Android/i.test(navigator.userAgent);
  ...
  return (
    <>
      ...
      >
        ...
        {/* Glowing Orbs */}
        <motion.div
          className="absolute top-20 right-10 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl will-change-transform"
          animate={{
            scale: [1, 1.3, 1],
            x: [0, -50, 0],
            y: [0, 50, 0],
        ...
        <motion.div
          className="absolute bottom-20 left-10 w-80 h-80 bg-purple-500/10 rounded-full blur-3xl will-change-transform"
          animate={{
            scale: [1, 1.2, 1],
            x: [0, 40, 0],
            y: [0, -40, 0],
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-14 items-center relative z-10">
          ...
          >
            <div className="relative">
              {/* Animated Rings */}
              <motion.div
                className="absolute inset-0 -m-8 will-change-transform"
                animate={{ rotate: 360 }}
                transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
              >
                <div className="w-full h-full rounded-2xl border-2 border-dashed border-cyan-400/30" />
              ...
              <motion.div
                className="absolute inset-0 -m-12 will-change-transform"
                animate={{ rotate: -360 }}
                transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
              >
                <div className="w-full h-full rounded-2xl border-2 border-dotted border-purple-400/20" />
              ...
              {/* Glow Effects */}
              <motion.div
                className="absolute inset-0 bg-cyan-400 blur-3xl opacity-30 rounded-2xl will-change-transform"
                animate={{
                  scale: [1, 1.1, 1],
                  opacity: [0.2, 0.4, 0.2],
                }}
              ...
              {/* Floating Tech Icons */}
              <motion.div
                className="absolute -top-6 -right-6 bg-gradient-to-br from-cyan-400 to-blue-500 p-4 rounded-2xl shadow-2xl will-change-transform"
                animate={{
                  y: [0, -15, 0],
                  rotate: [0, 5, 0],
                }}
              ...
              <motion.div
                className="absolute -bottom-6 -left-6 bg-gradient-to-br from-purple-500 to-pink-500 p-4 rounded-2xl shadow-2xl will-change-transform"
                animate={{
                  y: [0, 15, 0],
                  rotate: [0, -5, 0],
                }}
              ...
              <motion.div
                className="absolute top-1/2 -right-8 bg-gradient-to-br from-green-400 to-emerald-500 p-4 rounded-2xl shadow-2xl will-change-transform"
                animate={{
                  x: [0, 10, 0],
                  scale: [1, 1.1, 1],
                }}
