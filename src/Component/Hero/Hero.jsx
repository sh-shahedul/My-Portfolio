...
const Hero = () => {
  return (
    <section className="bg-background-light dark:bg-background-dark font-display">
      <section className=" flex items-center justify-center py-16 px-4 sm:px-6 lg:px-8 bg-linear-to-r from-[#0a101b] via-[#071322] to-[#04101F]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white">
                I'M <span className="text-primary">DEVELOPER</span><br />
                WILKERSON HARDIN
              </h1>
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                <a className="w-full sm:w-auto text-center bg-primary text-white font-bold py-3 px-8 rounded-full shadow-lg hover:opacity-90 transition-opacity duration-300" href="#contact">
                  Hire Me
                </a>
                <a className="w-full sm:w-auto flex items-center justify-center gap-2 font-bold py-3 px-8 rounded-full border-2 border-primary text-primary hover:bg-primary hover:text-white transition-colors duration-300" href="#">
            ...
            <div className="flex justify-center">
              <img 
                ...
                className="max-w-sm w-full md:max-w-md lg:max-w-none" 
